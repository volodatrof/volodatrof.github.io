...
<table border="1" align="center" cellpadding="10">
    <tr>
        <td background="bg-3.jpg"
         colspan="2" height="150" align="right" hspace="5"> 
            <font size="5" ><h1>Сайт web-студії "web-DECO"</h1></font>
    </tr><tr>
        <td colspan="2">
        <font size="4"><b>
        <a href="#">Головна</a>&nbsp;&nbsp;
        ...
        </font></td></tr><tr><td width="30%" valign="top">
        <center><canvas id="canvas" height="120" width="120"></canvas></center>
        <font size="5" color="navy"><h2>Новини</h2></font>
            <font size="5">
        <ul>
            <li><a href="#">Сайт будівельної компанії</a>
            <li><a href="#">Сайт ТМ "НОВАШКОЛА"</a>
                <li><a href="#">Редизайн сайту classno.com.ua"</a>
                    <li><a href="#">Розробка CMS для Metro Cash&Carry"</a>
                        <li><a href="#">Сайт-візитівка дизайнера інтерфейсів"</a><br>
                            <p align="right"><href="#>інші...</a></p>
        </ul>
        </font>
        <hr>
        ...
        <form action="forma.php" method="post" onsubmit="return send();">
            ...
            <p align="centre">
             ...
             Наша вебстудія допоможе, якщо Вам потрібно:</p>
             <p>
            <ul>
             ...
             <p></p>Ми будемо раді стати Вам у нагоді і створити веб-сайт, якісний і привабливий для відвідувача. Вебстудія Web-DECO надає цілий комплекс послуг з проектування сайтів, дизайну сайтів і розробки сайтів.</p>
             ...
             <p>
                <img src="images/penzli.jpg" height="140" width="140" align="lesf" hspace="15" vspace="5"> 
             ...
             <p>Звертайтесь до веб-студії Web-DECO, і ми з радістю застосуємо свої здібності і досвід для вирішення Ваших задач! Ми можемо створити сайт, який стане для Вас вдалою інвестицією.</td>
                ...
                <td background="bg-3.jpg"
                 colspan="2" valign="middle" height="90">
                    <font size="4">Сайт зробив "Трофімчук Володимир"</font>
                    </td>
                </tr>
            </table>
                    <!-- ============================================================= -->
